  ...
  function combine(module, node, parts) {
    var annotatedParts = parts.map(function (part, i) {
      ...
      if (previousPart) {
        ...
        var _insignificantContent2 = slicedToArray(_insignificantContent, 2);
      ...
      if (nextPart) {
        ...
        var _insignificantContent4 = slicedToArray(_insignificantContent3, 1);
...
var objectsConcise = Object.freeze({
  ...
  var OptionError = function (_Error) {
    ...
    function OptionError(message) {
      ...
      var _this = possibleConstructorReturn(this, Object.getPrototypeOf(OptionError).call(this, message));
